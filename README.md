...
| Felipe   | - Firebase + (Edit + Repo + English) = 125 pontos + Firebase Web Codelab (Repo + English) = 120 pontos + Firebase Cloud Function (Repo + English) = 100 pontos + Add Your Web App to a User's Home Screen + (Repo + English) = 70 pontos + Adding Push Notifications to a Web App + (Repo + English) = 100 pontos + Adding a Service Worker with sw-precache + (Repo + English) = 60 pontos + Autocomplete To Improve Your Forms + (Repo + English) = 80 pontos + Caching with progressive libraries + (Repo + English) = 100 pontos + Raw React — no JSX, no Flux, no ES6, no Webpack + (Repo + English) = 80 pontos                                                      | 835       |
